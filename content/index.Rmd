...
Using the `fig.cap` chunk option avoids the issue with redundant title warning that comes with `fig.alt`. However, the yaml option `fig_caption: false` must be used to avoid a redundant text warning.
